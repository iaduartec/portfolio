...
Alineación: hombros dentro de tolerancia (p.ej., 3-5% o ~0.6 ATR).

Clavicular: línea por los mínimos intermedios (puede ser inclinada)

Volumen:

Idealmente decreciente en la formación (H izq → cabeza → H dcho).

Confirmación:

rotura de clavicular (cierre por %/ATR y, si hay volumen, aumento relativo vs SMA).
...
Volumen: idealmente decreciente durante la formación y aumento en la ruptura.

Confirmación: ruptura alcista de clavicular (cierre por %/ATR y volumen relativo).
...
volOk = not useVolConfirm or (volume > vSMA * volMult)
